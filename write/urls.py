...
urlpatterns = [
    ...
    path('<int:manuscript_id>/delete/', views.delete_manuscript, name='delete'),
    path('<int:manuscript_id>/download.docx/', views.download_manuscript_docx, name='download_docx'),
    path('<int:manuscript_id>/submit-to-xanula/', views.submit_to_xanula, name='submit_to_xanula'),
    path('<int:manuscript_id>/save/', views.save_manuscript, name='save'),
    path('<int:manuscript_id>/walkthrough-seen/', views.mark_walkthrough_seen, name='walkthrough_seen'),
